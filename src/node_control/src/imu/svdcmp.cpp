...
static double dmaxarg1 = 0 ,dmaxarg2 = 0;
#define DMAX(a,b) (dmaxarg1=(a),dmaxarg2=(b),(dmaxarg1) > (dmaxarg2) ? (dmaxarg1) : (dmaxarg2))

static int iminarg1 = 0,iminarg2 = 0;
...
/* allocate a double matrix with subscript range m[nrl..nrh][ncl..nch] */
{
  ...
  size = (size_t)((nrow+NR_END)*sizeof(double*)) ;
  ...
  size = (size_t)((nrow*ncol+NR_END)*sizeof(double)) ;
	m[nrl]=(double *) malloc(size);
  memset(m[nrl], 0, size) ;
	m[nrl] += NR_END;
	m[nrl] -= ncl;
...
/* allocate a double vector with subscript range v[nl..nh] */
{
  ...
  size = (size_t) ((nh-nl+1+NR_END)*sizeof(double)) ;
